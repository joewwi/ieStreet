...
(function (global, factory) {
  ...
  $ = typeof $ !== 'undefined' && Object.prototype.hasOwnProperty.call($, 'default') ? $.default : $;
  Popper = typeof Popper !== 'undefined' && Object.prototype.hasOwnProperty.call(Popper, 'default') ? Popper.default : Popper;
  ...
  function _objectSpread(target, ...sources) {
    sources.forEach(source => {
      if (source != null) {
        const ownKeys = Object.keys(source).concat(
  ...
  const Util = {
    ...
    getTransitionDurationFromElement: function getTransitionDurationFromElement(element) {
      ...
      const transitionDuration = jQuery(element).css('transition-duration');
      const transitionDelay = jQuery(element).css('transition-delay');
